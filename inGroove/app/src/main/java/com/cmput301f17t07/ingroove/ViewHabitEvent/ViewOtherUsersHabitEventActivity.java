 ...
 * @see DataManagerAPI
 */
public class ViewOtherUsersHabitEventActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_other_user_habit_event_view);
