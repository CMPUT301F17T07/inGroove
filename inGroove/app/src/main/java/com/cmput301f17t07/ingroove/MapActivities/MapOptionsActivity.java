...
public class MapOptionsActivity extends NavigationDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        my_loc_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    if (!checkPermissions()) {
                        requestPermissions();
                        my_loc_switch.setChecked(false);
                    } else {
                        getLastLocation();
                    }
                }
        ...
        highlight_near_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    if (!checkPermissions()) {
                        requestPermissions();
                        highlight_near_switch.setChecked(false);
                    } else {
                        getLastLocation();
                    }
                }
    ...
    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(MapOptionsActivity.this,
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(MapOptionsActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(MapOptionsActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
